...
namespace kalender_tests
{
    ...
    public class Testings_Kalender
    {
        ...
        {
            var ergebnis = Monatskalender.Kalender_erstellen("2 2018");
            {
                Assert.AreEqual(new[]
                {
                    "    Februar 2018",
        ...
        {
            var ergebnis = Monatskalender.Erster_Wochentag_ermitteln("2018", "4");
        ...
        {
            var ergebnis = Monatskalender.Kalender_formatieren("    Februar 2018",
